...
pub use shared::library::store::package::Path;
use shared::library::store::package as sharedSelf;
use shared::PackageId as Id;
...
impl super::Pointer {
    ...
    pub async fn package_meta(&self, path: package::Path) -> Result<sharedSelf::Meta, MetaError> {
        type E = MetaError;
