use super::super::{globe::{ValId, TypeId}, module};
pub use crate::compiler::syntax::val::{Number, Boolean, String, Js, Array};
pub use sum::Value as Sum;
pub use product::Value as Product;
pub use r#enum::Value as Enum;
pub use crate::compiler::syntax::val::{js, number, string};
